...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2024 at 07:50 PM
...
INSERT INTO `applicants` (`ApplicantID`, `opportunityID`, `specialist_id`, `LetterPath`, `Status`) VALUES
(1, 1, 0, '889981.pdf', 'Pending'),
(2, 1, 0, '670534.pdf', 'Pending'),
(3, 1, 0, '656394.pdf', 'Pending'),
(4, 1, 0, '101833.pdf', 'Pending'),
(5, 1, 0, '885632.pdf', 'Pending'),
(6, 1, 0, '600373.pdf', 'Pending'),
(7, 1, 0, '173985.pdf', 'Pending'),
(8, 1, 0, '5592.pdf', 'Pending'),
(9, 1, 0, '412459.pdf', 'Pending'),
(10, 1, 0, '811670.pdf', 'Pending'),
(11, 1, 0, '388324.pdf', 'Pending'),
(12, 1, 0, '480290.pdf', 'Pending'),
(13, 1, 0, '932623.pdf', 'Pending'),
(14, 1, 0, '887073.pdf', 'Pending');
...
INSERT INTO `opportunity` (`opportunityID`, `Tittle`, `Description`, `Type`, `Requirements`, `StartDate`, `EndDate`, `ApplicationDeadline`, `CompanyID`, `applicantID`) VALUES
(1, 'Networking Opportunity', 'Connect wifi and likes', 'part time', 'diploma', '2024-08-03', '2024-08-09', '2024-08-05', NULL, NULL),
(2, 'Database admin', 'overall ', 'Full time', 'diploma', '2024-08-03', '2024-08-31', '2024-08-06', NULL, NULL),
(4, 'Software development', 'Both front end and backend develpers needed', 'Full time', 'Degree ', '2024-08-07', '2024-12-06', '2024-08-10', NULL, NULL),
(5, 'Kuparwa Opportunity', 'Ngombe BABA', 'part time', 'No Req', '2024-07-30', '2024-08-22', '2024-08-13', NULL, NULL);
...
ALTER TABLE `applicants`
  ...
  ADD KEY `applicants_fk` (`opportunityID`);
...
--
ALTER TABLE `opportunity`
  ADD CONSTRAINT `opportunity_ibfk_1` FOREIGN KEY (`CompanyID`) REFERENCES `company` (`CompanyID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `opportunity_ibfk_2` FOREIGN KEY (`applicantID`) REFERENCES `credentials` (`LoginID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
